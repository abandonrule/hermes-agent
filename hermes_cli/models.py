...
# Unsuffixed free slugs (e.g. big-pickle) that never appear in the ``*-free`` catalog list but
# are served keylessly on the Zen relay; membership here gates the keyless heal in
# ``opencode_zen_free_runtime`` alongside the catalog/suffix check.
